...
import com.hy.tvmeidaview.MyApp;
...
public final class SPUtils {
    ...
    public static SPUtils getInstance() {
        return getInstance("", MyApp.mmcontext);
    }
    ...
    public static SPUtils getInstance(String spName, Context context) {
        if (isSpace(spName)) spName = "spCache";
    ...
    public static void deleteFilesByDirectory(File directory, String ss) {
    ...
    public <T> void put(String key, T t) {
        if (t == null) {
            ...
            try {
                ...
                sp.edit().putString(key, payCityMapBase64).commit();
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
