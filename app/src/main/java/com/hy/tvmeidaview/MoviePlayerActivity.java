...
import com.hy.tvmeidaview.utils.ProgressUtils;
import com.hy.tvmeidaview.view.Movie;
import com.hy.tvmeidaview.view.MyVideoView;
...
public class MoviePlayerActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layFinishBg = findViewById(R.id.lay_finish_bg);
        btnPlayOrPause = findViewById(R.id.btn_play_or_pause);
        btnRestartPlay = findViewById(R.id.btn_restart_play);
        progressDialog = new ProgressUtils(this, R.style.custom_dialog2);

        string = (Movie) getIntent().getSerializableExtra("xx");
        Log.e("onCreate: ", string.toString() + "++");
        ...
        videoView.setOnErrorListener(new MediaPlayer.OnErrorListener() {
            ...
            public boolean onError(MediaPlayer mp, int what, int extra) {
                Toast.makeText(MoviePlayerActivity.this, "播放出错", Toast.LENGTH_SHORT).show();
                return false;
            }
        });
    ...
    private void initVideo() {
        //本地视频
//        Uri uri = Uri.parse("http://192.168.0.111:2222/smb/192.168.0.120/shareTV/test1.mp4");

        Uri uri = Uri.parse(string.getUrl());

        Log.e("initVideo: ", uri.toString());
